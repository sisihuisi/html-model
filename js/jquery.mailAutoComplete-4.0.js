...
(function($) {
	$.fn.mailAutoComplete = function(options) {
		var defaults = {
			className: "emailist",
			email: 	["qq.com","126.com","163.com","hotmail.com","yahoo.com","yahoo.com.cn","gmail.com","sohu.com","sina.com"], //邮件数组
			zIndex: 11	
		};
		// 最终参数
		...
		return $(this).each(function() {
			...
			}).addClass(params.className).on("click", function(e) {
			...
			// 不同浏览器的不同事件
			isModern? $(this).on("input", function() {
